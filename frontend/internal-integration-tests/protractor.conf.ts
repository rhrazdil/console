...
import { getPluginIntegrationTests } from '@console/plugin-sdk/src/codegen';
import { screenshotsDir, testName, browserLogs } from './src';
...
const pluginSuites = getPluginIntegrationTests();
