...
import { getPluginIntegrationTests } from '../plugin-integration-tests';
...
describe('getPluginIntegrationTests', () => {
  it('will not fail on missing tests.', () => {
    ...
    expect(getPluginIntegrationTests(monorepoRootDir, pluginFilter)).toEqual(expectedTests);
  });
