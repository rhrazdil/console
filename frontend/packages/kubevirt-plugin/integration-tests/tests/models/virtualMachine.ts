...
import { selectDropdownOption, waitForStringNotInElement, resolveTimeout } from '@console/shared/src/test-utils/utils';
      ...
      switch (action) {
        case 'Start':
          await this.waitForStatusIcon(
            ...
            resolveTimeout(timeout, VM_BOOTUP_TIMEOUT),
          );
          break;
        case 'Restart':
          await this.waitForStatusIcon(
        ...
        case 'Stop':
          await this.waitForStatusIcon(
            ...
            resolveTimeout(timeout, VM_STOP_TIMEOUT),
          );
          break;
        case 'Clone':
          await browser.wait(
            until.presenceOf(nameInput),
            resolveTimeout(timeout, PAGE_LOAD_TIMEOUT),
          );
        ...
        case 'Migrate':
          ...
          await this.waitForStatusIcon(
            vmView.statusIcons.running,
            resolveTimeout(timeout, VM_ACTIONS_TIMEOUT),
          );
          break;
        case 'Cancel':
          await this.waitForStatusIcon(
