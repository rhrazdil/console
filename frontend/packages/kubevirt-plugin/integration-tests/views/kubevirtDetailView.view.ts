...
import { resourceRows } from '@console/integration-tests/views/crud.view';
...
// Used to determine presence of new row by looking for confirmation buttons
...
export const itemInRow = (rowName, itemNumber) =>
  rowForName(rowName)
    .$$('div')
    .get(itemNumber);
